...
menu() {
    ...
    echo -e "# ${GREEN}作者${PLAIN}: liCha                                      #"
    echo -e "# ${GREEN}运营二开${PLAIN}: https://t.me/licha101                                    #"
    echo -e "# ${GREEN}合作${PLAIN}: https://t.me/licha101                                   #"
    echo -e "# ${GREEN}技术支持${PLAIN}: https://t.me/licha101                               #"
    echo -e "# ${GREEN}和我联系${PLAIN}: https://t.me/licha101 #"
    echo "#############################################################"
    echo ""
